...
public class MemberArticle {
    ...
    public MemberArticle(String firstname, String lastname, String usn, String semester, String title,
                       String introduction, String body1, String body2, String conclusion) {
